;(function($,window,document,undefined){
    ...
    var jason = {
        init:   function(){
            ...
            that.section3Fn();
            that.section4Fn();
            that.loginSection2Fn(); // 로그인
            that.main1_1Fn(); // 메인1-1
        ...
        main1_1Fn:function(){
            ...
            var $section2WrapW = $('#main1-1 #section2 .wrap').innerWidth(); // .wrap 박스너비 
            var $section2ImgWrap = $('#main1-1 #section2 .img-wrap'); // 갤러리 이미지 박스요소
            var $window = $(window);
            var $winW = $window.innerWidth();
            var n = 3;
            ...
            function resizeFn(){
                ...
                if($winW > 1280){ // 1281 이상 : 이미지 3개
                    n = 3;                    
                }
                else if($winW > 860){ // 861 ~ 1280 : 이미지 2개 
                    n = 2;                    
                }
                else{ // 860 이하 : 이미지 1개
                    n = 1;                    
                ...
                $section2ImgWrap.css({height:($section2WrapW/n)*0.689985}); // 갤러리 이미지박스 높이

                console.log(n);
                console.log('이미지너비', $section2WrapW85);
                console.log('이미지높이', ($section2WrapW/n)*0.689985);
            }
